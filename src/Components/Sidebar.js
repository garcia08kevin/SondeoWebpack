    ...
    return (
        ...
        <div class="flex flex-col w-60 rounded-r-3xl overflow-hidden">
          ...
          <ul class="flex flex-col py-4">
            ...
            <li>
              <a href="/controlProduct" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
